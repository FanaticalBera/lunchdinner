...
export const ResultScreen: React.FC<Props> = ({ onRestart, onReWeight }) => {
    return (
        <div className="flex-1 flex flex-col bg-[var(--bg-color)] h-[100dvh] relative overflow-hidden">
            ...
            {/* Background Glow */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-emerald-500/10 dark:bg-emerald-500/5 blur-[100px] rounded-full pointer-events-none -translate-y-1/2" />
            ...
            >
                ...
                <motion.div
                    ...
                    className="relative bg-[var(--surface-color)] rounded-3xl p-7 text-center shadow-[0_20px_60px_-15px_rgba(16,185,129,0.15)] dark:shadow-[0_20px_60px_-15px_rgba(16,185,129,0.05)] w-full border border-emerald-500/20 group overflow-hidden"
                >
                    {/* Shimmer effect */}
                    <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-white/40 dark:via-white/5 to-transparent -translate-x-full group-hover:animate-[shimmer_2s_infinite] pointer-events-none" />
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        ...
                        <motion.div
                            ...
                            className="absolute -top-[44px] text-amber-400 drop-shadow-lg"
                        >
                            <Crown weight="fill" size={52} />
                        </motion.div>

                        <div className="w-24 h-24 bg-emerald-50 dark:bg-emerald-500/10 rounded-3xl flex items-center justify-center text-4xl mb-5 shadow-inner border border-emerald-100 dark:border-emerald-500/20 mt-5 relative overflow-hidden">
                            <motion.span
                        ...
                        <div className="w-full bg-[var(--bg-color)] rounded-2xl p-4 text-sm leading-relaxed text-[var(--text-secondary)] font-medium border border-[var(--border-color)] flex flex-col gap-2.5 text-left shadow-inner">
                            <div className="flex justify-between items-center border-b border-[var(--border-color)] pb-2.5">
                                ...
                                <strong className="text-emerald-500 text-xl font-display font-bold tracking-tight">88점</strong>
                            </div>
